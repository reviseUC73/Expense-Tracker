...
class _ExpensesBottomSheet extends State<ExpensesBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (contextLayout, constraints) {
      print("\n ค่า size ของ widget นี้");
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                if (width > 600) //Row2 # CatagoryBox and PataPicker
                  Row(
                    children: [
                      DropdownButton(
                ...
                if (width > 600) //Row3 # Button Save and Cancel
                  Row(
                    children: [
                      const Spacer(),
                      TextButton(
